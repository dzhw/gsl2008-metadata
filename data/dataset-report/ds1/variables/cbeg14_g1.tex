%EVERY VARIABLE HAS IT'S OWN PAGE
    ...
    %omit vertical space
    \vspace*{-1.8cm}
	\section{cbeg14\_g1 (14. Tätigkeit: Beginn (Jahr))}
	\label{section:cbeg14_g1}
  ...
  % '#' has to be escaped
    ...
    \noindent\textbf{Eigenschaften\footnote{Detailliertere Informationen zur Variable finden sich unter
		\url{https://metadata.fdz.dzhw.eu/\#!/de/variables/var-gsl2008-ds1-cbeg14_g1$}}}\\
    ...
    %dann evtl. nur die erste verwenden oder etwas anderes tun (Hinweis mehrere Fragen, auflisten mit Link)
		...
		Dieser Variable ist keine Frage zugeordnet.
                ...
                \vspace*{-\baselineskip}
					...
					\begin{filecontents}{\jobname-cbeg14_g1}
				...
				% TODO try size/length gt 0; take over for other passages
					...
					\end{longtable}
					\end{filecontents}
					\LTXtable{\textwidth}{\jobname-cbeg14_g1}
				\label{tableValues:cbeg14_g1}
				\vspace*{-\baselineskip}
                    \begin{noten}
