%EVERY VARIABLE HAS IT'S OWN PAGE
    ...
    %omit vertical space
    \vspace*{-1.8cm}
	\section{cend02\_g1 (2. Tätigkeit: Ende (Jahr))}
	\label{section:cend02_g1}
  ...
  % '#' has to be escaped
    ...
    \noindent\textbf{Eigenschaften\footnote{Detailliertere Informationen zur Variable finden sich unter
		\url{https://metadata.fdz.dzhw.eu/\#!/de/variables/var-gsl2008-ds1-cend02_g1$}}}\\
 ...
 \\
                ...
                \vspace*{-\baselineskip}
					...
					\begin{filecontents}{\jobname-cend02_g1}
				...
				% TODO try size/length gt 0; take over for other passages
					...
					\end{longtable}
					\end{filecontents}
					\LTXtable{\textwidth}{\jobname-cend02_g1}
				\label{tableValues:cend02_g1}
				\vspace*{-\baselineskip}
                    \begin{noten}
                	    ...
                	    ; 
                	      Minimum ($min$): 2008; 
                	      Maximum ($max$): 2012; 
                	      arithmetisches Mittel ($\bar{x}$): \num[round-mode=places,round-precision=2]{2009.7993}; 
                	      Median ($\tilde{x}$): 2009; 
                	      Modus ($h$): 2009; 
                	      Standardabweichung ($s$): \num[round-mode=places,round-precision=2]{1.4334}; 
                	      Schiefe ($v$): \num[round-mode=places,round-precision=2]{0.2269}; 
                	      Wölbung ($w$): \num[round-mode=places,round-precision=2]{1.6353}
                     \end{noten}
