%EVERY VARIABLE HAS IT'S OWN PAGE
 ...
 \\
                ...
                \vspace*{-\baselineskip}
					...
					\begin{filecontents}{\jobname-cbeg23_g1}
				...
				% TODO try size/length gt 0; take over for other passages
					...
					\end{longtable}
					\end{filecontents}
					\LTXtable{\textwidth}{\jobname-cbeg23_g1}
				\label{tableValues:cbeg23_g1}
				\vspace*{-\baselineskip}
                    \begin{noten}
                	    ...
                	    ; 
                	      Minimum ($min$): 2008; 
                	      Maximum ($max$): 2012; 
                	      arithmetisches Mittel ($\bar{x}$): \num[round-mode=places,round-precision=2]{2011.2634}; 
                	      Median ($\tilde{x}$): 2011; 
                	      Modus ($h$): 2012; 
                	      Standardabweichung ($s$): \num[round-mode=places,round-precision=2]{0.8185}; 
                	      Schiefe ($v$): \num[round-mode=places,round-precision=2]{-0.964}; 
                	      Wölbung ($w$): \num[round-mode=places,round-precision=2]{3.6985}
                     \end{noten}
