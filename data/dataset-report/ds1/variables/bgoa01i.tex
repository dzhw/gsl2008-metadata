%EVERY VARIABLE HAS IT'S OWN PAGE
    ...
    %omit vertical space
    \vspace*{-1.8cm}
	\section{bgoa01i (Ziel: Überdurchschnittliches leisten)}
	\label{section:bgoa01i}
  ...
  % '#' has to be escaped
    ...
    \noindent\textbf{Eigenschaften\footnote{Detailliertere Informationen zur Variable finden sich unter
		\url{https://metadata.fdz.dzhw.eu/\#!/de/variables/var-gsl2008-ds1-bgoa01i$}}}\\
 ...
 \\
					%--
					Fragetext: & Wie stark verfolgen Sie die nachstehenden Berufs- und Lebensziele?\par  Mir geht es darum, in beruflicher Hinsicht Überdurchschnittliches zu leisten \\
				\end{tabularx}
                ...
                \vspace*{-\baselineskip}
					...
					\begin{filecontents}{\jobname-bgoa01i}
				...
				% TODO try size/length gt 0; take over for other passages
					...
					\end{longtable}
					\end{filecontents}
					\LTXtable{\textwidth}{\jobname-bgoa01i}
				\label{tableValues:bgoa01i}
				\vspace*{-\baselineskip}
                    \begin{noten}
