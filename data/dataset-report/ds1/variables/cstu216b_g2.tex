%EVERY VARIABLE HAS IT'S OWN PAGE
    ...
    %omit vertical space
    \vspace*{-1.8cm}
	\section{cstu216b\_g2 (6. Tätigkeit: 2. Studienfach (Fächergruppe))}
	\label{section:cstu216b_g2}
  ...
  % '#' has to be escaped
    ...
    \noindent\textbf{Eigenschaften\footnote{Detailliertere Informationen zur Variable finden sich unter
		\url{https://metadata.fdz.dzhw.eu/\#!/de/variables/var-gsl2008-ds1-cstu216b_g2$}}}\\
 ...
 \\
                ...
                \vspace*{-\baselineskip}
					...
					\begin{filecontents}{\jobname-cstu216b_g2}
				...
				% TODO try size/length gt 0; take over for other passages
					...
					\end{longtable}
					\end{filecontents}
					\LTXtable{\textwidth}{\jobname-cstu216b_g2}
				\label{tableValues:cstu216b_g2}
				\vspace*{-\baselineskip}
                    \begin{noten}
