%EVERY VARIABLE HAS IT'S OWN PAGE
 ...
 \\
                ...
                \vspace*{-\baselineskip}
					...
					\begin{filecontents}{\jobname-cjob0522d}
					...
					\end{longtable}
					\end{filecontents}
					\LTXtable{\textwidth}{\jobname-cjob0522d}
				\label{tableValues:cjob0522d}
				\vspace*{-\baselineskip}
                    \begin{noten}
                	    \note{} Deskriptive Maßzahlen:
                	    Anzahl unterschiedlicher Beobachtungen: 183%
                	    ; 
                	      Minimum ($min$): 0; 
                	      Maximum ($max$): 3000; 
                	      arithmetisches Mittel ($\bar{x}$): \num[round-mode=places,round-precision=2]{491.5784}; 
                	      Median ($\tilde{x}$): 383.5; 
                	      Modus ($h$): 400; 
                	      Standardabweichung ($s$): \num[round-mode=places,round-precision=2]{466.2438}; 
                	      Schiefe ($v$): \num[round-mode=places,round-precision=2]{2.2999}; 
                	      Wölbung ($w$): \num[round-mode=places,round-precision=2]{9.2156}
                     \end{noten}
