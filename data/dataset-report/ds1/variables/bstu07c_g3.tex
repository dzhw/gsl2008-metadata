%EVERY VARIABLE HAS IT'S OWN PAGE
    ...
    %omit vertical space
    \vspace*{-1.8cm}
	\section{bstu07c\_g3 (3. Nennung: Studienfach (Fächergruppe))}
	\label{section:bstu07c_g3}
  ...
  % '#' has to be escaped
    ...
    \noindent\textbf{Eigenschaften\footnote{Detailliertere Informationen zur Variable finden sich unter
		\url{https://metadata.fdz.dzhw.eu/\#!/de/variables/var-gsl2008-ds1-bstu07c_g3$}}}\\
 ...
 \\
                ...
                \vspace*{-\baselineskip}
					...
					\begin{filecontents}{\jobname-bstu07c_g3}
				...
				% TODO try size/length gt 0; take over for other passages
					...
					\end{longtable}
					\end{filecontents}
					\LTXtable{\textwidth}{\jobname-bstu07c_g3}
				\label{tableValues:bstu07c_g3}
				\vspace*{-\baselineskip}
                    \begin{noten}
