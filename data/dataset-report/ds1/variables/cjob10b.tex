%EVERY VARIABLE HAS IT'S OWN PAGE
    ...
    %omit vertical space
    \vspace*{-1.8cm}
	\section{cjob10b (berufliche Zufriedenheit: Position)}
	\label{section:cjob10b}
  ...
  % '#' has to be escaped
    ...
    \noindent\textbf{Eigenschaften\footnote{Detailliertere Informationen zur Variable finden sich unter
		\url{https://metadata.fdz.dzhw.eu/\#!/de/variables/var-gsl2008-ds1-cjob10b$}}}\\
 ...
 \\
					%--
					Fragetext: & Wie zufrieden sind Sie mit Ihrer beruflichen Tätigkeit in Bezug auf …?\par  berufliche Position \\
				\end{tabularx}
                ...
                \vspace*{-\baselineskip}
					...
					\begin{filecontents}{\jobname-cjob10b}
				...
				% TODO try size/length gt 0; take over for other passages
					...
					\end{longtable}
					\end{filecontents}
					\LTXtable{\textwidth}{\jobname-cjob10b}
				\label{tableValues:cjob10b}
				\vspace*{-\baselineskip}
                    \begin{noten}
