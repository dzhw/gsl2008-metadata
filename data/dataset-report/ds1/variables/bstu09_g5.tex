%EVERY VARIABLE HAS IT'S OWN PAGE
    ...
    %omit vertical space
    \vspace*{-1.8cm}
	\section{bstu09\_g5 (1. Qualifikation: Hochschulart (FH/Uni; ohne Saarland))}
	\label{section:bstu09_g5}
  ...
  % '#' has to be escaped
    ...
    \noindent\textbf{Eigenschaften\footnote{Detailliertere Informationen zur Variable finden sich unter
		\url{https://metadata.fdz.dzhw.eu/\#!/de/variables/var-gsl2008-ds1-bstu09_g5$}}}\\
 ...
 \\
                ...
                \vspace*{-\baselineskip}
					...
					\begin{filecontents}{\jobname-bstu09_g5}
				...
				% TODO try size/length gt 0; take over for other passages
					...
					\end{longtable}
					\end{filecontents}
					\LTXtable{\textwidth}{\jobname-bstu09_g5}
				\label{tableValues:bstu09_g5}
				\vspace*{-\baselineskip}
                    \begin{noten}
