%EVERY VARIABLE HAS IT'S OWN PAGE
    ...
    %omit vertical space
    \vspace*{-1.8cm}
	\section{cact1213\_g1 (13. Tätigkeit: andere Tätigkeit (Art))}
	\label{section:cact1213_g1}
  ...
  % '#' has to be escaped
    ...
    \noindent\textbf{Eigenschaften\footnote{Detailliertere Informationen zur Variable finden sich unter
		\url{https://metadata.fdz.dzhw.eu/\#!/de/variables/var-gsl2008-ds1-cact1213_g1$}}}\\
    ...
    %dann evtl. nur die erste verwenden oder etwas anderes tun (Hinweis mehrere Fragen, auflisten mit Link)
		...
		Dieser Variable ist keine Frage zugeordnet.
                ...
                \vspace*{-\baselineskip}
					...
					\begin{filecontents}{\jobname-cact1213_g1}
				...
				% TODO try size/length gt 0; take over for other passages
					...
					\end{longtable}
					\end{filecontents}
					\LTXtable{\textwidth}{\jobname-cact1213_g1}
				\label{tableValues:cact1213_g1}
				\vspace*{-\baselineskip}
                    \begin{noten}
