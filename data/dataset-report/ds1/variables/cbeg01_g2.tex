%EVERY VARIABLE HAS IT'S OWN PAGE
    ...
    %omit vertical space
    \vspace*{-1.8cm}
	\section{cbeg01\_g2 (1. Tätigkeit: Beginn (Monat))}
	\label{section:cbeg01_g2}
  ...
  % '#' has to be escaped
    ...
    \noindent\textbf{Eigenschaften\footnote{Detailliertere Informationen zur Variable finden sich unter
		\url{https://metadata.fdz.dzhw.eu/\#!/de/variables/var-gsl2008-ds1-cbeg01_g2$}}}\\
 ...
 \\
                ...
                \vspace*{-\baselineskip}
					...
					\begin{filecontents}{\jobname-cbeg01_g2}
				...
				% TODO try size/length gt 0; take over for other passages
					...
					\end{longtable}
					\end{filecontents}
					\LTXtable{\textwidth}{\jobname-cbeg01_g2}
				\label{tableValues:cbeg01_g2}
				\vspace*{-\baselineskip}
                    \begin{noten}
