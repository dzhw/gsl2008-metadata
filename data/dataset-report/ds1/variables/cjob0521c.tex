%EVERY VARIABLE HAS IT'S OWN PAGE
 ...
 \\
                ...
                \vspace*{-\baselineskip}
					...
					\begin{filecontents}{\jobname-cjob0521c}
					...
					\end{longtable}
					\end{filecontents}
					\LTXtable{\textwidth}{\jobname-cjob0521c}
				\label{tableValues:cjob0521c}
				\vspace*{-\baselineskip}
                    \begin{noten}
                	    ...
                	    ; 
                	      Minimum ($min$): 1; 
                	      Maximum ($max$): 99; 
                	      arithmetisches Mittel ($\bar{x}$): \num[round-mode=places,round-precision=2]{43.2023}; 
                	      Median ($\tilde{x}$): 38; 
                	      Modus ($h$): 99; 
                	      Standardabweichung ($s$): \num[round-mode=places,round-precision=2]{29.9518}; 
                	      Schiefe ($v$): \num[round-mode=places,round-precision=2]{0.7838}; 
                	      Wölbung ($w$): \num[round-mode=places,round-precision=2]{2.3675}
                     \end{noten}
