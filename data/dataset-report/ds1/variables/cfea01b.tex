%EVERY VARIABLE HAS IT'S OWN PAGE
    ...
    %omit vertical space
    \vspace*{-1.8cm}
	\section{cfea01b (Sorgen Studium: Orientierung verlieren)}
	\label{section:cfea01b}
  ...
  % '#' has to be escaped
    ...
    \noindent\textbf{Eigenschaften\footnote{Detailliertere Informationen zur Variable finden sich unter
		\url{https://metadata.fdz.dzhw.eu/\#!/de/variables/var-gsl2008-ds1-cfea01b$}}}\\
 ...
 \\
					%--
					Fragetext: & Wenn Sie an Ihr derzeitiges Studium denken, was bereitet Ihnen persönlich Sorge?\par  in der Vielfalt der Fachinhalte die Orientierung zu verlieren \\
				\end{tabularx}
                ...
                \vspace*{-\baselineskip}
					...
					\begin{filecontents}{\jobname-cfea01b}
				...
				% TODO try size/length gt 0; take over for other passages
					...
					\end{longtable}
					\end{filecontents}
					\LTXtable{\textwidth}{\jobname-cfea01b}
				\label{tableValues:cfea01b}
				\vspace*{-\baselineskip}
                    \begin{noten}
