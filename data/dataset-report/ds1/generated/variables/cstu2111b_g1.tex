%EVERY VARIABLE HAS IT'S OWN PAGE
    ...
    %omit vertical space
    \vspace*{-1.8cm}
	\section{cstu2111b\_g1 (11. Tätigkeit: 2. Studienfach (Studienbereich))}
	\label{section:cstu2111b_g1}
	...
	\footnote{Detailliertere Informationen zur Variable finden sich unter
		\url{https://metadata.fdz.dzhw.eu/\#!/de/variables/var-gsl2008-ds1-cstu2111b_g1$}}}\\
    ...
    %dann evtl. nur die erste verwenden oder etwas anderes tun (Hinweis mehrere Fragen, auflisten mit Link)
		...
		Dieser Variable ist keine Frage zugeordnet.
                ...
                \vspace*{-\baselineskip}
					...
					\begin{filecontents}{\jobname-cstu2111b_g1}
				...
				% TODO try size/length gt 0; take over for other passages
					...
					\end{longtable}
					\end{filecontents}
					\LTXtable{\textwidth}{\jobname-cstu2111b_g1}
				\label{tableValues:cstu2111b_g1}
				\vspace*{-\baselineskip}
                    \begin{noten}
