%EVERY VARIABLE HAS IT'S OWN PAGE
    ...
    %omit vertical space
    \vspace*{-1.8cm}
	\section{bmot01v (Bedeutung für Werdegang: Übereinstimmung mit eigener Leistungsfähigkeit)}
	\label{section:bmot01v}
	...
	\footnote{Detailliertere Informationen zur Variable finden sich unter
		\url{https://metadata.fdz.dzhw.eu/\#!/de/variables/var-gsl2008-ds1-bmot01v$}}}\\
 ...
 \\
					%--
					Fragetext: & Welche Bedeutung haben die folgenden Gründe und Motive für den von Ihnen gewählten nachschulischen Werdegang?\par  gute Übereinstimmung mit der eigenen Leistungsfähigkeit \\
				\end{tabularx}
                ...
                \vspace*{-\baselineskip}
					...
					\begin{filecontents}{\jobname-bmot01v}
				...
				% TODO try size/length gt 0; take over for other passages
					...
					\end{longtable}
					\end{filecontents}
					\LTXtable{\textwidth}{\jobname-bmot01v}
				\label{tableValues:bmot01v}
				\vspace*{-\baselineskip}
                    \begin{noten}
