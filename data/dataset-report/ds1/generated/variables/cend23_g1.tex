%EVERY VARIABLE HAS IT'S OWN PAGE
 ...
 \\
                ...
                \vspace*{-\baselineskip}
					...
					\begin{filecontents}{\jobname-cend23_g1}
				...
				% TODO try size/length gt 0; take over for other passages
					...
					%146 &
					  \num{146} &
					%--
					  \num[round-mode=places,round-precision=2]{23,78} &
				...
				% TODO try size/length gt 0; take over for other passages
					...
					%428 &
					  \num{428} &
					%--
					  \num[round-mode=places,round-precision=2]{69,71} &
					...
					\end{longtable}
					\end{filecontents}
					\LTXtable{\textwidth}{\jobname-cend23_g1}
				\label{tableValues:cend23_g1}
				\vspace*{-\baselineskip}
                    \begin{noten}
                	    ...
                	    ; 
                	      Minimum ($min$): 2009; 
                	      Maximum ($max$): 2012; 
                	      arithmetisches Mittel ($\bar{x}$): \num[round-mode=places,round-precision=2]{2011,6287}; 
                	      Median ($\tilde{x}$): 2012; 
                	      Modus ($h$): 2012; 
                	      Standardabweichung ($s$): \num[round-mode=places,round-precision=2]{0,6143}; 
                	      Schiefe ($v$): \num[round-mode=places,round-precision=2]{-1,5131}; 
                	      Wölbung ($w$): \num[round-mode=places,round-precision=2]{4,5182}
                     \end{noten}
