%EVERY VARIABLE HAS IT'S OWN PAGE
    ...
    %omit vertical space
    \vspace*{-1.8cm}
	\section{bmot01g (Bedeutung für Werdegang: späteres Berufsspektrum)}
	\label{section:bmot01g}
	...
	\footnote{Detailliertere Informationen zur Variable finden sich unter
		\url{https://metadata.fdz.dzhw.eu/\#!/de/variables/var-gsl2008-ds1-bmot01g$}}}\\
 ...
 \\
					%--
					Fragetext: & Welche Bedeutung haben die folgenden Gründe und Motive für den von Ihnen gewählten nachschulischen Werdegang?\par  das breite sich später eröffnende Berufsspektrum \\
				\end{tabularx}
                ...
                \vspace*{-\baselineskip}
					...
					\begin{filecontents}{\jobname-bmot01g}
				...
				% TODO try size/length gt 0; take over for other passages
					...
					\end{longtable}
					\end{filecontents}
					\LTXtable{\textwidth}{\jobname-bmot01g}
				\label{tableValues:bmot01g}
				\vspace*{-\baselineskip}
                    \begin{noten}
