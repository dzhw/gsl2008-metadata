%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{cact1214\_g1r}
	\label{subSection:cact1214_g1r}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:cact1214_g1r}
			Name & cact1214\_g1r \\
			Label & 14. Tätigkeit: Tätigkeitsart \\
			Beschreibung & - \\
 ...
 \\
		...
		\end{tabular}
			...
			\noindent\textbf{Werte:}\\
			\begin{table}[!ht]
				\label{tableValues:cact1214_g1r}
				\centering
				\begin{tabular}{C{1cm}L{6cm}rrR{1.5cm}}
					...
					\multicolumn{5}{l}{\textbf{Gültige Werte}}\\										
								...
								2 & Universität & 2 & 0.01 & 66.67 \\
								48 & FH / Praktikum & 1 & 0 & 33.33 \\
					...
					\bottomrule		
				\end{tabular}
				\caption{Werte der Variable cact1214\_g1r}
			\end{table}
