%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{cend22\_g1r}
	\label{subSection:cend22_g1r}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:cend22_g1r}
			Name & cend22\_g1r \\
			Label & 2. Job: Ende (Jahr) \\
			Beschreibung & - \\
 ...
 \\
		...
		\noindent\textbf{Frage:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableQuestion:cend22_g1r}
			Nummer & 4.14 \\
...
Ende Monat/Jahr \\
		...
		\noindent\textbf{Statistische Daten:}\\
			\begin{tabular}{ll}
				\label{tableStatistics:cend22_g1r}
		...
		\end{minipage}%				
			...
			\begin{axis}
	  		...
	  		\end{axis}
			\end{tikzpicture}
			\captionof{figure}{cend22\_g1r Verteilungen}
			\end{minipage}
			...
			\label{tableValues:cend22_g1r}
				...
				\bottomrule					
				\end{tabular}
				\caption{Werte der Variable cend22\_g1r}
			\end{table}
