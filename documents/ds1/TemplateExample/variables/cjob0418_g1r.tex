%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{cjob0418\_g1r}
	\label{subSection:cjob0418_g1r}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:cjob0418_g1r}
			Name & cjob0418\_g1r \\
			Label & 18. Tätigkeit: Beruf Erwerbstätigkeit \\
			Beschreibung & - \\
 ...
 \\
		...
		\end{tabular}
			...
			\noindent\textbf{Werte:}\\
			\begin{table}[!ht]
				\label{tableValues:cjob0418_g1r}
				\centering
				\begin{tabular}{C{1cm}L{6cm}rrR{1.5cm}}
					...
					\multicolumn{5}{l}{\textbf{Gültige Werte}}\\										
								...
								2 & Studium an Universität & 1 & 0 & 100 \\
					...
					\bottomrule		
				\end{tabular}
				\caption{Werte der Variable cjob0418\_g1r}
			\end{table}
