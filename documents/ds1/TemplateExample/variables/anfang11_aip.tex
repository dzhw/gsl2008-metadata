%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{anfang11\_aip}
	\label{subSection:anfang11_aip}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:anfang11_aip}
			Name & anfang11\_aip \\
			Label & Anfangstermin 11.Tätigkeit \\
			Beschreibung & - \\
		...
		\end{minipage}%				
			...
			\begin{axis}
	    		[
		    	    ...
		    	    use comma,
	    	    		1000 sep={},
    				ytick = {201010,201110,201210,201210,201210},
    			...
    			\addplot+[
      			...
      			lower quartile=201110,
	    		  	...
	    		  	lower whisker=201010
    				},
    			] coordinates {};
	  		\end{axis}
			\end{tikzpicture}
			\captionof{figure}{anfang11\_aip Verteilungen}
			\end{minipage}
