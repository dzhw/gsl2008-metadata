%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{cend30\_g1r}
	\label{subSection:cend30_g1r}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:cend30_g1r}
			Name & cend30\_g1r \\
			Label & 10. Job: Ende (Jahr) \\
			Beschreibung & - \\
 ...
 \\
		...
		\end{minipage}%				
			...
			\label{tableValues:cend30_g1r}
				...
				\bottomrule					
				\end{tabular}
				\caption{Werte der Variable cend30\_g1r}
			\end{table}
