%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{anfang17\_aip}
	\label{subSection:anfang17_aip}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:anfang17_aip}
			Name & anfang17\_aip \\
			Label & Anfangstermin 17.Tätigkeit \\
			Beschreibung & - \\
 ...
 \\
		...
		\end{minipage}%				
			...
			\begin{axis}
	  		...
	  		\end{axis}
			\end{tikzpicture}
			\captionof{figure}{anfang17\_aip Verteilungen}
			\end{minipage}
