%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{anfang08\_aip}
	\label{subSection:anfang08_aip}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:anfang08_aip}
			Name & anfang08\_aip \\
			Label & Anfangstermin 8.Tätigkeit \\
			Beschreibung & - \\
		...
		\end{minipage}%				
			...
			\begin{axis}
	    		[
		    	    ...
		    	    use comma,
	    	    		1000 sep={},
    				ytick = {200960,201110,201200,201210,201210},
    			...
    			\addplot+[
      			...
      			lower quartile=201110,
	    		  	...
	    		  	lower whisker=200960
    				},
    			] coordinates {};
	  		\end{axis}
			\end{tikzpicture}
			\captionof{figure}{anfang08\_aip Verteilungen}
			\end{minipage}
