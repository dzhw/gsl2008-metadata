%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{cstu2111b\_g3r}
	\label{subSection:cstu2111b_g3r}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:cstu2111b_g3r}
			Name & cstu2111b\_g3r \\
			Label & 11. Tätigkeit: 2. Studienfach (Fächergruppe) \\
			Beschreibung & - \\
 ...
 \\
		...
		\end{tabular}
			...
			\noindent\textbf{Werte:}\\
			\begin{table}[!ht]
				\label{tableValues:cstu2111b_g3r}
				\centering
				\begin{tabular}{C{1cm}L{6cm}rrR{1.5cm}}
					...
					\multicolumn{5}{l}{\textbf{Gültige Werte}}\\										
								...
								1 & Sprach-/Kultur-/Sportwissenschaften & 5 & 0.02 & 55.56 \\
								2 & Wirtschafts-/Sozialwissenschaften & 4 & 0.01 & 44.44 \\
					...
					\bottomrule		
				\end{tabular}
				\caption{Werte der Variable cstu2111b\_g3r}
			\end{table}
