%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{cbeg29\_g1r}
	\label{subSection:cbeg29_g1r}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:cbeg29_g1r}
			Name & cbeg29\_g1r \\
			Label & 9. Job: Beginn (Jahr) \\
			Beschreibung & - \\
 ...
 \\
		...
		\end{minipage}%				
			...
			\label{tableValues:cbeg29_g1r}
				...
				\bottomrule					
				\end{tabular}
				\caption{Werte der Variable cbeg29\_g1r}
			\end{table}
