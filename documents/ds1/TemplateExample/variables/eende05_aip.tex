%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{eende05\_aip}
	\label{subSection:eende05_aip}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:eende05_aip}
			Name & eende05\_aip \\
			Label & Ende Job5 \\
			Beschreibung & - \\
		...
		\end{minipage}%				
			...
			\begin{axis}
	    		[
		    	    ...
		    	    use comma,
	    	    		1000 sep={},
    				ytick = {201190,201200,201210,201210,201220},
    			...
    			\addplot+[
      			...
      			lower quartile=201200,
    	  			upper whisker=201220,
	    		  	lower whisker=201190
    				},
    			] coordinates {};
	  		\end{axis}
			\end{tikzpicture}
			\captionof{figure}{eende05\_aip Verteilungen}
			\end{minipage}
