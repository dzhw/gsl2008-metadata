%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{ende09\_aip}
	\label{subSection:ende09_aip}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:ende09_aip}
			Name & ende09\_aip \\
			Label & Endtermin 9.Tätigkeit \\
			Beschreibung & - \\
 ...
 \\
		...
		\end{minipage}%				
			...
			\begin{axis}
	  		...
	  		\end{axis}
			\end{tikzpicture}
			\captionof{figure}{ende09\_aip Verteilungen}
			\end{minipage}
