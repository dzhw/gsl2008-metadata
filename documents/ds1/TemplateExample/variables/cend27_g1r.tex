%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{cend27\_g1r}
	\label{subSection:cend27_g1r}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:cend27_g1r}
			Name & cend27\_g1r \\
			Label & 7. Job: Ende (Jahr) \\
			Beschreibung & - \\
 ...
 \\
		...
		\noindent\textbf{Statistische Daten:}\\
			\begin{tabular}{ll}
				\label{tableStatistics:cend27_g1r}
		...
		\end{minipage}%				
			...
			\begin{axis}
	  		...
	  		\end{axis}
			\end{tikzpicture}
			\captionof{figure}{cend27\_g1r Verteilungen}
			\end{minipage}
			...
			\label{tableValues:cend27_g1r}
				...
				\bottomrule					
				\end{tabular}
				\caption{Werte der Variable cend27\_g1r}
			\end{table}
