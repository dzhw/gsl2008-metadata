%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{cend30\_g2r}
	\label{subSection:cend30_g2r}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:cend30_g2r}
			Name & cend30\_g2r \\
			Label & 10. Job: Ende (Monat) \\
			Beschreibung & - \\
 ...
 \\
		...
		\end{minipage}%				
			...
			\label{tableValues:cend30_g2r}
				...
				\bottomrule					
				\end{tabular}
				\caption{Werte der Variable cend30\_g2r}
			\end{table}
