%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{cstu2116b\_g3r}
	\label{subSection:cstu2116b_g3r}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:cstu2116b_g3r}
			Name & cstu2116b\_g3r \\
			Label & 16. Tätigkeit: 2. Studienfach (Fächergruppe) \\
			Beschreibung & - \\
 ...
 \\
		...
		\end{tabular}
			...
			\noindent\textbf{Werte:}\\
			\begin{table}[!ht]
				\label{tableValues:cstu2116b_g3r}
				\centering
				\begin{tabular}{C{1cm}L{6cm}rrR{1.5cm}}
					...
					\bottomrule		
				\end{tabular}
				\caption{Werte der Variable cstu2116b\_g3r}
			\end{table}
