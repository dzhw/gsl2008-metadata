%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{anfang13\_aip}
	\label{subSection:anfang13_aip}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:anfang13_aip}
			Name & anfang13\_aip \\
			Label & Anfangstermin 13.Tätigkeit \\
			Beschreibung & - \\
		...
		\end{minipage}%				
			...
			\begin{axis}
	    		[
		    	    ...
		    	    use comma,
	    	    		1000 sep={},
    				ytick = {201100,201110,201200,201210,201210},
	  		...
	  		\end{axis}
			\end{tikzpicture}
			\captionof{figure}{anfang13\_aip Verteilungen}
			\end{minipage}
