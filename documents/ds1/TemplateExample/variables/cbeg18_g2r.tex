%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{cbeg18\_g2r}
	\label{subSection:cbeg18_g2r}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:cbeg18_g2r}
			Name & cbeg18\_g2r \\
			Label & 18. Tätigkeit: Beginn (Monat)  \\
			Beschreibung & - \\
 ...
 \\
		...
		\noindent\textbf{Statistische Daten:}\\
			\begin{tabular}{ll}
				\label{tableStatistics:cbeg18_g2r}
		...
		\end{minipage}%				
			...
			\begin{axis}
	  		...
	  		\end{axis}
			\end{tikzpicture}
			\captionof{figure}{cbeg18\_g2r Verteilungen}
			\end{minipage}
			...
			\label{tableValues:cbeg18_g2r}
				...
				\bottomrule					
				\end{tabular}
				\caption{Werte der Variable cbeg18\_g2r}
			\end{table}
