%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{cjob0527a\_g2r}
	\label{subSection:cjob0527a_g2r}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:cjob0527a_g2r}
			Name & cjob0527a\_g2r \\
			Label & 7. Job: Arbeitsort (PLZ-Leitregion) \\
			Beschreibung & - \\
 ...
 \\
		...
		\end{tabular}
			...
			\noindent\textbf{Werte:}\\
			\begin{table}[!ht]
				\label{tableValues:cjob0527a_g2r}
				\centering
				\begin{tabular}{C{1cm}L{6cm}rrR{1.5cm}}
					...
					\bottomrule		
				\end{tabular}
				\caption{Werte der Variable cjob0527a\_g2r}
			\end{table}
