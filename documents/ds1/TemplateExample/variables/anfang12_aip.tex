%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{anfang12\_aip}
	\label{subSection:anfang12_aip}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:anfang12_aip}
			Name & anfang12\_aip \\
			Label & Anfangstermin 12.Tätigkeit \\
			Beschreibung & - \\
		...
		\end{minipage}%				
			...
			\begin{axis}
	    		[
		    	    ...
		    	    use comma,
	    	    		1000 sep={},
    				ytick = {201100,201110,201160,201210,201210},
    			...
    			\addplot+[
      			...
      			lower quartile=201110,
	    		  	...
	    		  	lower whisker=201100
    				},
    			] coordinates {};
	  		\end{axis}
			\end{tikzpicture}
			\captionof{figure}{anfang12\_aip Verteilungen}
			\end{minipage}
