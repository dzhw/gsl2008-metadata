%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{cbeg27\_g1r}
	\label{subSection:cbeg27_g1r}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:cbeg27_g1r}
			Name & cbeg27\_g1r \\
			Label & 7. Job: Beginn (Jahr) \\
			Beschreibung & - \\
 ...
 \\
		...
		\noindent\textbf{Statistische Daten:}\\
			\begin{tabular}{ll}
				\label{tableStatistics:cbeg27_g1r}
		...
		\end{minipage}%				
			...
			\begin{axis}
	  		...
	  		\end{axis}
			\end{tikzpicture}
			\captionof{figure}{cbeg27\_g1r Verteilungen}
			\end{minipage}
			...
			\label{tableValues:cbeg27_g1r}
				...
				\bottomrule					
				\end{tabular}
				\caption{Werte der Variable cbeg27\_g1r}
			\end{table}
