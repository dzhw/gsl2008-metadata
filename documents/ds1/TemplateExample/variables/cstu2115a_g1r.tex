%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{cstu2115a\_g1r}
	\label{subSection:cstu2115a_g1r}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:cstu2115a_g1r}
			Name & cstu2115a\_g1r \\
			Label & 15. Tätigkeit: 1. Studienfach (Studienbereich) \\
			Beschreibung & - \\
 ...
 \\
		...
		\end{tabular}
			...
			\noindent\textbf{Werte:}\\
			\begin{table}[!ht]
				\label{tableValues:cstu2115a_g1r}
				\centering
				\begin{tabular}{C{1cm}L{6cm}rrR{1.5cm}}
					...
					\bottomrule		
				\end{tabular}
				\caption{Werte der Variable cstu2115a\_g1r}
			\end{table}
