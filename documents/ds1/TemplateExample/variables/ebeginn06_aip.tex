%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{ebeginn06\_aip}
	\label{subSection:ebeginn06_aip}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:ebeginn06_aip}
			Name & ebeginn06\_aip \\
			Label & Beginn Job6 \\
			Beschreibung & - \\
 ...
 \\
		...
		\end{minipage}%				
			...
			\begin{axis}
	  		...
	  		\end{axis}
			\end{tikzpicture}
			\captionof{figure}{ebeginn06\_aip Verteilungen}
			\end{minipage}
