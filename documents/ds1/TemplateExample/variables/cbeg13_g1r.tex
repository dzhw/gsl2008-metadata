%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{cbeg13\_g1r}
	\label{subSection:cbeg13_g1r}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:cbeg13_g1r}
			Name & cbeg13\_g1r \\
			Label & 13. Tätigkeit: Beginn (Jahr)  \\
			Beschreibung & - \\
 ...
 \\
		...
		\noindent\textbf{Statistische Daten:}\\
			\begin{tabular}{ll}
				\label{tableStatistics:cbeg13_g1r}
		...
		\end{minipage}%				
			...
			\begin{axis}
	  		...
	  		\end{axis}
			\end{tikzpicture}
			\captionof{figure}{cbeg13\_g1r Verteilungen}
			\end{minipage}
			...
			\label{tableValues:cbeg13_g1r}
				...
				\bottomrule					
				\end{tabular}
				\caption{Werte der Variable cbeg13\_g1r}
			\end{table}
