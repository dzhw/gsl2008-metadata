%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{ebeginn05\_aip}
	\label{subSection:ebeginn05_aip}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:ebeginn05_aip}
			Name & ebeginn05\_aip \\
			Label & Beginn Job5 \\
			Beschreibung & - \\
		...
		\end{minipage}%				
			...
			\begin{axis}
	    		[
		    	    ...
		    	    use comma,
	    	    		1000 sep={},
    				ytick = {201190,201200,201200,201210,201210},
	  		...
	  		\end{axis}
			\end{tikzpicture}
			\captionof{figure}{ebeginn05\_aip Verteilungen}
			\end{minipage}
