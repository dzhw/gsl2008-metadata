%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{fw12term\_aip}
	\label{subSection:fw12term_aip}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:fw12term_aip}
			Name & fw12term\_aip \\
			Label & Zeitpunkt des Wechsels \\
			Beschreibung & - \\
		...
		\end{minipage}%				
			...
			\begin{axis}
	    		[
		    	    ...
		    	    use comma,
	    	    		1000 sep={},
    				ytick = {200810,200910,201000,201100,201390},
    			...
    			\addplot+[
      			...
      			lower quartile=200910,
    	  			upper whisker=201390,
	    		  	lower whisker=200810
    				},
    			] coordinates {};
	  		\end{axis}
			\end{tikzpicture}
			\captionof{figure}{fw12term\_aip Verteilungen}
			\end{minipage}
