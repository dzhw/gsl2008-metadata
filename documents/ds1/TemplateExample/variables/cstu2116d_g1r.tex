%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{cstu2116d\_g1r}
	\label{subSection:cstu2116d_g1r}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:cstu2116d_g1r}
			Name & cstu2116d\_g1r \\
			Label & 16. Tätigkeit: Bundesland der HS \\
			Beschreibung & - \\
 ...
 \\
		...
		\end{tabular}
			...
			\noindent\textbf{Werte:}\\
			\begin{table}[!ht]
				\label{tableValues:cstu2116d_g1r}
				\centering
				\begin{tabular}{C{1cm}L{6cm}rrR{1.5cm}}
					...
					\bottomrule		
				\end{tabular}
				\caption{Werte der Variable cstu2116d\_g1r}
			\end{table}
