%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{cact1218\_g1r}
	\label{subSection:cact1218_g1r}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:cact1218_g1r}
			Name & cact1218\_g1r \\
			Label & 18. Tätigkeit: Tätigkeitsart \\
			Beschreibung & - \\
 ...
 \\
		...
		\end{tabular}
			...
			\noindent\textbf{Werte:}\\
			\begin{table}[!ht]
				\label{tableValues:cact1218_g1r}
				\centering
				\begin{tabular}{C{1cm}L{6cm}rrR{1.5cm}}
					...
					\multicolumn{5}{l}{\textbf{Gültige Werte}}\\										
								...
								10 & Ausländische Hochschule & 1 & 0 & 100 \\
					...
					\bottomrule		
				\end{tabular}
				\caption{Werte der Variable cact1218\_g1r}
			\end{table}
