%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{anfang15\_aip}
	\label{subSection:anfang15_aip}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:anfang15_aip}
			Name & anfang15\_aip \\
			Label & Anfangstermin 15.Tätigkeit \\
			Beschreibung & - \\
 ...
 \\
		...
		\end{minipage}%				
			...
			\begin{axis}
	  		...
	  		\end{axis}
			\end{tikzpicture}
			\captionof{figure}{anfang15\_aip Verteilungen}
			\end{minipage}
