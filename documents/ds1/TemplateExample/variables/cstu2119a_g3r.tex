%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{cstu2119a\_g3r}
	\label{subSection:cstu2119a_g3r}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:cstu2119a_g3r}
			Name & cstu2119a\_g3r \\
			Label & 19. Tätigkeit: 1. Studienfach (Fächergruppe) \\
			Beschreibung & - \\
 ...
 \\
		...
		\end{tabular}
			...
			\noindent\textbf{Werte:}\\
			\begin{table}[!ht]
				\label{tableValues:cstu2119a_g3r}
				\centering
				\begin{tabular}{C{1cm}L{6cm}rrR{1.5cm}}
					...
					\bottomrule		
				\end{tabular}
				\caption{Werte der Variable cstu2119a\_g3r}
			\end{table}
