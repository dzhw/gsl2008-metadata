%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{ende11\_aip}
	\label{subSection:ende11_aip}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:ende11_aip}
			Name & ende11\_aip \\
			Label & Endtermin 11.Tätigkeit \\
			Beschreibung & - \\
 ...
 \\
		...
		\end{minipage}%				
			...
			\begin{axis}
	  		...
	  		\end{axis}
			\end{tikzpicture}
			\captionof{figure}{ende11\_aip Verteilungen}
			\end{minipage}
