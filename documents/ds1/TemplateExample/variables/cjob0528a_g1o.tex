%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{cjob0528a\_g1o}
	\label{subSection:cjob0528a_g1o}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:cjob0528a_g1o}
			Name & cjob0528a\_g1o \\
			Label & 8. Job: Arbeitsort (PLZ) \\
			Beschreibung & - \\
		...
		\end{tabular}
			...
			\begin{table}[!ht]
				...
				\begin{tabular}{C{1cm}L{6cm}rrR{1.5cm}}
					...
					\bottomrule		
				\end{tabular}
				\caption{Werte der Variable cjob0528a\_g1o}
			\end{table}
