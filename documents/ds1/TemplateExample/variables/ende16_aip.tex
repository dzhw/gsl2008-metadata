%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{ende16\_aip}
	\label{subSection:ende16_aip}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:ende16_aip}
			Name & ende16\_aip \\
			Label & Endtermin 16.Tätigkeit \\
			Beschreibung & - \\
 ...
 \\
		...
		\end{minipage}%				
			...
			\begin{axis}
	  		...
	  		\end{axis}
			\end{tikzpicture}
			\captionof{figure}{ende16\_aip Verteilungen}
			\end{minipage}
