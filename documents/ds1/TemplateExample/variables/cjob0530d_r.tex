%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{cjob0530d\_r}
	\label{subSection:cjob0530d_r}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:cjob0530d_r}
			Name & cjob0530d\_r \\
			Label & 10. Job: Netto-Monatseinkommen \\
			Beschreibung & - \\
 ...
 \\
		...
		\end{minipage}%				
			...
			\label{tableValues:cjob0530d_r}
				...
				\bottomrule					
				\end{tabular}
				\caption{Werte der Variable cjob0530d\_r}
			\end{table}
