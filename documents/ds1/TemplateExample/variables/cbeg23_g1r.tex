%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{cbeg23\_g1r}
	\label{subSection:cbeg23_g1r}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:cbeg23_g1r}
			Name & cbeg23\_g1r \\
			Label & 3. Job: Beginn (Jahr) \\
			Beschreibung & - \\
 ...
 \\
		...
		\noindent\textbf{Frage:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableQuestion:cbeg23_g1r}
			Nummer & 4.14 \\
...
Beginn Monat/Jahr \\
		...
		\noindent\textbf{Statistische Daten:}\\
			\begin{tabular}{ll}
				\label{tableStatistics:cbeg23_g1r}
		...
		\end{minipage}%				
			...
			\begin{axis}
	    		[
		    	    ...
		    	    use comma,
	    	    		1000 sep={},
    				ytick = {2009.5,2011,2011,2012,2012},
	  		...
	  		\end{axis}
			\end{tikzpicture}
			\captionof{figure}{cbeg23\_g1r Verteilungen}
			\end{minipage}
			...
			\label{tableValues:cbeg23_g1r}
				...
				\bottomrule					
				\end{tabular}
				\caption{Werte der Variable cbeg23\_g1r}
			\end{table}
