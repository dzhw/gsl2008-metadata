%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{eende03\_aip}
	\label{subSection:eende03_aip}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:eende03_aip}
			Name & eende03\_aip \\
			Label & Ende Job3 \\
			Beschreibung & - \\
		...
		\end{minipage}%				
			...
			\begin{axis}
	    		[
		    	    ...
		    	    use comma,
	    	    		1000 sep={},
    				ytick = {200950,201110,201210,201210,201300},
	  		...
	  		\end{axis}
			\end{tikzpicture}
			\captionof{figure}{eende03\_aip Verteilungen}
			\end{minipage}
