%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{cend28\_g1r}
	\label{subSection:cend28_g1r}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:cend28_g1r}
			Name & cend28\_g1r \\
			Label & 8. Job: Ende (Jahr) \\
			Beschreibung & - \\
 ...
 \\
		...
		\noindent\textbf{Statistische Daten:}\\
			\begin{tabular}{ll}
				\label{tableStatistics:cend28_g1r}
		...
		\end{minipage}%				
			...
			\begin{axis}
	  		...
	  		\end{axis}
			\end{tikzpicture}
			\captionof{figure}{cend28\_g1r Verteilungen}
			\end{minipage}
			...
			\label{tableValues:cend28_g1r}
				...
				\bottomrule					
				\end{tabular}
				\caption{Werte der Variable cend28\_g1r}
			\end{table}
