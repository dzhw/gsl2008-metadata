%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{ebeginn02\_aip}
	\label{subSection:ebeginn02_aip}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:ebeginn02_aip}
			Name & ebeginn02\_aip \\
			Label & Beginn Job2 \\
			Beschreibung & - \\
		...
		\end{minipage}%				
			...
			\begin{axis}
	    		[
		    	    ...
		    	    use comma,
	    	    		1000 sep={},
    				ytick = {200810,201010,201110,201200,201210},
	  		...
	  		\end{axis}
			\end{tikzpicture}
			\captionof{figure}{ebeginn02\_aip Verteilungen}
			\end{minipage}
