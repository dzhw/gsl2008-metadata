%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{cstu2116b\_g2r}
	\label{subSection:cstu2116b_g2r}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:cstu2116b_g2r}
			Name & cstu2116b\_g2r \\
			Label & 16. Tätigkeit: 2. Studienfach (Studiengattung) \\
			Beschreibung & - \\
 ...
 \\
		...
		\end{tabular}
			...
			\noindent\textbf{Werte:}\\
			\begin{table}[!ht]
				\label{tableValues:cstu2116b_g2r}
				\centering
				\begin{tabular}{C{1cm}L{6cm}rrR{1.5cm}}
					...
					\bottomrule		
				\end{tabular}
				\caption{Werte der Variable cstu2116b\_g2r}
			\end{table}
