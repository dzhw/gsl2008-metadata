%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{cbeg30\_g1r}
	\label{subSection:cbeg30_g1r}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:cbeg30_g1r}
			Name & cbeg30\_g1r \\
			Label & 10. Job: Beginn (Jahr) \\
			Beschreibung & - \\
 ...
 \\
		...
		\end{minipage}%				
			...
			\label{tableValues:cbeg30_g1r}
				...
				\bottomrule					
				\end{tabular}
				\caption{Werte der Variable cbeg30\_g1r}
			\end{table}
