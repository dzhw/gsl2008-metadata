%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{ebeginn07\_aip}
	\label{subSection:ebeginn07_aip}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:ebeginn07_aip}
			Name & ebeginn07\_aip \\
			Label & Beginn Job7 \\
			Beschreibung & - \\
 ...
 \\
		...
		\end{minipage}%				
			...
			\begin{axis}
	  		...
	  		\end{axis}
			\end{tikzpicture}
			\captionof{figure}{ebeginn07\_aip Verteilungen}
			\end{minipage}
