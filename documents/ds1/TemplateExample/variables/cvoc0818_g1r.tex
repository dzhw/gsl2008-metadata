%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{cvoc0818\_g1r}
	\label{subSection:cvoc0818_g1r}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:cvoc0818_g1r}
			Name & cvoc0818\_g1r \\
			Label & 18. Tätigkeit: Ausbildungsberuf \\
			Beschreibung & - \\
 ...
 \\
		...
		\end{tabular}
			...
			\noindent\textbf{Werte:}\\
			\begin{table}[!ht]
				\label{tableValues:cvoc0818_g1r}
				\centering
				\begin{tabular}{C{1cm}L{6cm}rrR{1.5cm}}
					...
					\bottomrule		
				\end{tabular}
				\caption{Werte der Variable cvoc0818\_g1r}
			\end{table}
