%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{anfang06\_aip}
	\label{subSection:anfang06_aip}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:anfang06_aip}
			Name & anfang06\_aip \\
			Label & Anfangstermin 6.Tätigkeit \\
			Beschreibung & - \\
		...
		\end{minipage}%				
			...
			\begin{axis}
	    		[
		    	    ...
		    	    use comma,
	    	    		1000 sep={},
    				ytick = {200940,201100,201200,201210,201210},
	  		...
	  		\end{axis}
			\end{tikzpicture}
			\captionof{figure}{anfang06\_aip Verteilungen}
			\end{minipage}
