%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{ebeginn04\_aip}
	\label{subSection:ebeginn04_aip}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:ebeginn04_aip}
			Name & ebeginn04\_aip \\
			Label & Beginn Job4 \\
			Beschreibung & - \\
 ...
 \\
		...
		\end{minipage}%				
			...
			\begin{axis}
	  		...
	  		\end{axis}
			\end{tikzpicture}
			\captionof{figure}{ebeginn04\_aip Verteilungen}
			\end{minipage}
