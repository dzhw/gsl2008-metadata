%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{ebeginn08\_aip}
	\label{subSection:ebeginn08_aip}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:ebeginn08_aip}
			Name & ebeginn08\_aip \\
			Label & Beginn Job8 \\
			Beschreibung & - \\
 ...
 \\
		...
		\end{minipage}%				
			...
			\begin{axis}
	  		...
	  		\end{axis}
			\end{tikzpicture}
			\captionof{figure}{ebeginn08\_aip Verteilungen}
			\end{minipage}
