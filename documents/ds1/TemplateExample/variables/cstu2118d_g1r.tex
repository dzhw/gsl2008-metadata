%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{cstu2118d\_g1r}
	\label{subSection:cstu2118d_g1r}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:cstu2118d_g1r}
			Name & cstu2118d\_g1r \\
			Label & 18. Tätigkeit: Bundesland der HS \\
			Beschreibung & - \\
 ...
 \\
		...
		\end{tabular}
			...
			\noindent\textbf{Werte:}\\
			\begin{table}[!ht]
				\label{tableValues:cstu2118d_g1r}
				\centering
				\begin{tabular}{C{1cm}L{6cm}rrR{1.5cm}}
					...
					\multicolumn{5}{l}{\textbf{Gültige Werte}}\\										
								...
								9990 & Hochschulen im Ausland & 1 & 0 & 100 \\
					...
					\bottomrule		
				\end{tabular}
				\caption{Werte der Variable cstu2118d\_g1r}
			\end{table}
