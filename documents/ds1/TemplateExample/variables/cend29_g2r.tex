%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{cend29\_g2r}
	\label{subSection:cend29_g2r}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:cend29_g2r}
			Name & cend29\_g2r \\
			Label & 9. Job: Ende (Monat) \\
			Beschreibung & - \\
 ...
 \\
		...
		\end{minipage}%				
			...
			\label{tableValues:cend29_g2r}
				...
				\bottomrule					
				\end{tabular}
				\caption{Werte der Variable cend29\_g2r}
			\end{table}
