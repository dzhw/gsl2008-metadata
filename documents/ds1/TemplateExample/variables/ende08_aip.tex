%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{ende08\_aip}
	\label{subSection:ende08_aip}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:ende08_aip}
			Name & ende08\_aip \\
			Label & Endtermin 8.Tätigkeit \\
			Beschreibung & - \\
 ...
 \\
		...
		\end{minipage}%				
			...
			\begin{axis}
	  		...
	  		\end{axis}
			\end{tikzpicture}
			\captionof{figure}{ende08\_aip Verteilungen}
			\end{minipage}
