%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{cbeg20\_g1r}
	\label{subSection:cbeg20_g1r}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:cbeg20_g1r}
			Name & cbeg20\_g1r \\
			Label & 20. Tätigkeit: Beginn (Jahr)  \\
			Beschreibung & - \\
 ...
 \\
		...
		\end{minipage}%				
			...
			\label{tableValues:cbeg20_g1r}
				...
				\bottomrule					
				\end{tabular}
				\caption{Werte der Variable cbeg20\_g1r}
			\end{table}
