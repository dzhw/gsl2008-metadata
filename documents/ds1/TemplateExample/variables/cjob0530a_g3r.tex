%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{cjob0530a\_g3r}
	\label{subSection:cjob0530a_g3r}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:cjob0530a_g3r}
			Name & cjob0530a\_g3r \\
			Label & 10. Job: Arbeitsort (Staat im Ausland) \\
			Beschreibung & - \\
 ...
 \\
		...
		\end{tabular}
			...
			\noindent\textbf{Werte:}\\
			\begin{table}[!ht]
				\label{tableValues:cjob0530a_g3r}
				\centering
				\begin{tabular}{C{1cm}L{6cm}rrR{1.5cm}}
					...
					\bottomrule		
				\end{tabular}
				\caption{Werte der Variable cjob0530a\_g3r}
			\end{table}
