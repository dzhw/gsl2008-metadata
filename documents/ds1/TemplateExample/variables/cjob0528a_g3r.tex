%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{cjob0528a\_g3r}
	\label{subSection:cjob0528a_g3r}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:cjob0528a_g3r}
			Name & cjob0528a\_g3r \\
			Label & 8. Job: Arbeitsort (Staat im Ausland) \\
			Beschreibung & - \\
 ...
 \\
		...
		\end{tabular}
			...
			\noindent\textbf{Werte:}\\
			\begin{table}[!ht]
				\label{tableValues:cjob0528a_g3r}
				\centering
				\begin{tabular}{C{1cm}L{6cm}rrR{1.5cm}}
					...
					\bottomrule		
				\end{tabular}
				\caption{Werte der Variable cjob0528a\_g3r}
			\end{table}
