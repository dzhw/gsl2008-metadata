%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{ende15\_aip}
	\label{subSection:ende15_aip}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:ende15_aip}
			Name & ende15\_aip \\
			Label & Endtermin 15.Tätigkeit \\
			Beschreibung & - \\
 ...
 \\
		...
		\end{minipage}%				
			...
			\begin{axis}
	  		...
	  		\end{axis}
			\end{tikzpicture}
			\captionof{figure}{ende15\_aip Verteilungen}
			\end{minipage}
