%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{cbeg07\_g1r}
	\label{subSection:cbeg07_g1r}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:cbeg07_g1r}
			Name & cbeg07\_g1r \\
			Label & 7. Tätigkeit: Beginn (Jahr)  \\
			Beschreibung & - \\
 ...
 \\
		...
		\noindent\textbf{Frage:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableQuestion:cbeg07_g1r}
			Nummer & 2.1 \\
...
Erziehungszeit, Arbeitslosigkeit – mit ihren jeweiligen Anfangs- und Endterminen an. Tragen Sie die Tätigkeiten in die entsprechenden Spalten ein bzw. machen Sie die entsprechenden „Kreuze“. Verwenden Sie immer dann eine neue Zeile, wenn sich eine Änderung der Tätigkeit – beispielsweise auch Wechsel des Studienfachs oder der Hochschule – ergeben hat. Wichtig ist für uns, dass im zeitlichen Ablauf keine Lücken entstehen. Wenn sich wesentliche Tätigkeiten zeitlich überschneiden, geben Sie jede in einer eigenen Zeile an. \\
		...
		\noindent\textbf{Statistische Daten:}\\
			\begin{tabular}{ll}
				\label{tableStatistics:cbeg07_g1r}
		...
		\end{minipage}%				
			...
			\begin{axis}
	  		...
	  		\end{axis}
			\end{tikzpicture}
			\captionof{figure}{cbeg07\_g1r Verteilungen}
			\end{minipage}
			...
			\label{tableValues:cbeg07_g1r}
				...
				\bottomrule					
				\end{tabular}
				\caption{Werte der Variable cbeg07\_g1r}
			\end{table}
