%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{cbeg15\_g1r}
	\label{subSection:cbeg15_g1r}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:cbeg15_g1r}
			Name & cbeg15\_g1r \\
			Label & 15. Tätigkeit: Beginn (Jahr)  \\
			Beschreibung & - \\
 ...
 \\
		...
		\noindent\textbf{Statistische Daten:}\\
			\begin{tabular}{ll}
				\label{tableStatistics:cbeg15_g1r}
		...
		\end{minipage}%				
			...
			\begin{axis}
	  		...
	  		\end{axis}
			\end{tikzpicture}
			\captionof{figure}{cbeg15\_g1r Verteilungen}
			\end{minipage}
			...
			\label{tableValues:cbeg15_g1r}
				...
				\bottomrule					
				\end{tabular}
				\caption{Werte der Variable cbeg15\_g1r}
			\end{table}
