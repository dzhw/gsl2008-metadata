%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{cjob0527a\_g3r}
	\label{subSection:cjob0527a_g3r}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:cjob0527a_g3r}
			Name & cjob0527a\_g3r \\
			Label & 7. Job: Arbeitsort (Staat im Ausland) \\
			Beschreibung & - \\
 ...
 \\
		...
		\end{tabular}
			...
			\noindent\textbf{Werte:}\\
			\begin{table}[!ht]
				\label{tableValues:cjob0527a_g3r}
				\centering
				\begin{tabular}{C{1cm}L{6cm}rrR{1.5cm}}
					...
					\multicolumn{5}{l}{\textbf{Fehlende Werte}}\\
							...
							-988 & trifft nicht zu & 2 & 0.01 & - \\						
					
					\midrule
					\multicolumn{2}{l}{\textbf{Summe (gesamt)}} & \textbf{28182} & \textbf{100} & \textbf{-} \\			
					\bottomrule		
				\end{tabular}
				\caption{Werte der Variable cjob0527a\_g3r}
			\end{table}
