%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{anfang10\_aip}
	\label{subSection:anfang10_aip}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:anfang10_aip}
			Name & anfang10\_aip \\
			Label & Anfangstermin 10.Tätigkeit \\
			Beschreibung & - \\
		...
		\end{minipage}%				
			...
			\begin{axis}
	    		[
		    	    ...
		    	    use comma,
	    	    		1000 sep={},
    				ytick = {201190,201200,201210,201210,201210},
    			...
    			\addplot+[
      			...
      			lower quartile=201200,
	    		  	...
	    		  	lower whisker=201190
    				},
    			] coordinates {};
	  		\end{axis}
			\end{tikzpicture}
			\captionof{figure}{anfang10\_aip Verteilungen}
			\end{minipage}
