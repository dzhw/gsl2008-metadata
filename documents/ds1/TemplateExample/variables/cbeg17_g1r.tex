%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{cbeg17\_g1r}
	\label{subSection:cbeg17_g1r}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:cbeg17_g1r}
			Name & cbeg17\_g1r \\
			Label & 17. Tätigkeit: Beginn (Jahr)  \\
			Beschreibung & - \\
 ...
 \\
		...
		\noindent\textbf{Statistische Daten:}\\
			\begin{tabular}{ll}
				\label{tableStatistics:cbeg17_g1r}
		...
		\end{minipage}%				
			...
			\begin{axis}
	  		...
	  		\end{axis}
			\end{tikzpicture}
			\captionof{figure}{cbeg17\_g1r Verteilungen}
			\end{minipage}
			...
			\label{tableValues:cbeg17_g1r}
				...
				\bottomrule					
				\end{tabular}
				\caption{Werte der Variable cbeg17\_g1r}
			\end{table}
