%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{cvoc0813\_g2r}
	\label{subSection:cvoc0813_g2r}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:cvoc0813_g2r}
			Name & cvoc0813\_g2r \\
			Label & 13. Tätigkeit: Berufsbereich Ausbildung \\
			Beschreibung & - \\
 ...
 \\
		...
		\end{tabular}
			...
			\noindent\textbf{Werte:}\\
			\begin{table}[!ht]
				\label{tableValues:cvoc0813_g2r}
				\centering
				\begin{tabular}{C{1cm}L{6cm}rrR{1.5cm}}
					...
					\bottomrule		
				\end{tabular}
				\caption{Werte der Variable cvoc0813\_g2r}
			\end{table}
