%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{ebeginn03\_aip}
	\label{subSection:ebeginn03_aip}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:ebeginn03_aip}
			Name & ebeginn03\_aip \\
			Label & Beginn Job3 \\
			Beschreibung & - \\
		...
		\end{minipage}%				
			...
			\begin{axis}
	    		[
		    	    ...
		    	    use comma,
	    	    		1000 sep={},
    				ytick = {200950,201100,201110,201210,201210},
	  		...
	  		\end{axis}
			\end{tikzpicture}
			\captionof{figure}{ebeginn03\_aip Verteilungen}
			\end{minipage}
