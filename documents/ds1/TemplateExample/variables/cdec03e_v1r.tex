%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{cdec03e\_v1r}
	\label{subSection:cdec03e_v1r}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:cdec03e_v1r}
			Name & cdec03e\_v1r \\
			Label & Grund Studienverzicht: Anforderungen unkalkulierbar \\
			Beschreibung & - \\
 ...
 \\
		...
		\noindent\textbf{Frage:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableQuestion:cdec03e_v1r}
			Nummer & 6.1 \\
...
Die Anforderungen eines solchen Studiums sind unübersichtlich und unkalkulierbar. \\
			...
			\begin{table}[!ht]
				...
				\begin{tabular}{C{1cm}L{6cm}rrR{1.5cm}}
					...
					\multicolumn{5}{l}{\textbf{Gültige Werte}}\\										
								...
								0 & nicht genannt & 1392 & 4.94 & 97.07 \\
								1 & genannt & 42 & 0.15 & 2.93 \\
					...
					\bottomrule		
				\end{tabular}
				\caption{Werte der Variable cdec03e\_v1r}
			\end{table}
