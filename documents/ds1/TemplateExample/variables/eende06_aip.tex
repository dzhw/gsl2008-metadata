%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{eende06\_aip}
	\label{subSection:eende06_aip}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:eende06_aip}
			Name & eende06\_aip \\
			Label & Ende Job6 \\
			Beschreibung & - \\
		...
		\end{minipage}%				
			...
			\begin{axis}
	    		[
		    	    ...
		    	    use comma,
	    	    		1000 sep={},
    				ytick = {201110,201110,201160,201210,201210},
	  		...
	  		\end{axis}
			\end{tikzpicture}
			\captionof{figure}{eende06\_aip Verteilungen}
			\end{minipage}
