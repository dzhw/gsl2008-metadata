%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{anfang16\_aip}
	\label{subSection:anfang16_aip}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:anfang16_aip}
			Name & anfang16\_aip \\
			Label & Anfangstermin 16.Tätigkeit \\
			Beschreibung & - \\
		...
		\end{minipage}%				
			...
			\begin{axis}
	    		[
		    	    ...
		    	    use comma,
	    	    		1000 sep={},
    				ytick = {201200,201200,201200,201200,201200},
    			...
    			\addplot+[
    				boxplot prepared={
	      		median=201200,
    		  		upper quartile=201200,
      			lower quartile=201200,
    	  			upper whisker=201200,
	    		  	lower whisker=201200
    				},
    			] coordinates {};
	  		\end{axis}
			\end{tikzpicture}
			\captionof{figure}{anfang16\_aip Verteilungen}
			\end{minipage}
