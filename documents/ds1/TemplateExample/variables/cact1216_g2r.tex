%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{cact1216\_g2r}
	\label{subSection:cact1216_g2r}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:cact1216_g2r}
			Name & cact1216\_g2r \\
			Label & 16. Tätigkeit: Tätigkeitsgruppe  \\
			Beschreibung & - \\
 ...
 \\
		...
		\end{tabular}
			...
			\noindent\textbf{Werte:}\\
			\begin{table}[!ht]
				\label{tableValues:cact1216_g2r}
				\centering
				\begin{tabular}{C{1cm}L{6cm}rrR{1.5cm}}
					...
					\bottomrule		
				\end{tabular}
				\caption{Werte der Variable cact1216\_g2r}
			\end{table}
