%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{ex12term\_aip}
	\label{subSection:ex12term_aip}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:ex12term_aip}
			Name & ex12term\_aip \\
			Label & Examenstermin \\
			Beschreibung & - \\
		...
		\end{minipage}%				
			...
			\begin{axis}
	    		[
		    	    ...
		    	    use comma,
	    	    		1000 sep={},
    				ytick = {201010,201110,201200,201210,201210},
	  		...
	  		\end{axis}
			\end{tikzpicture}
			\captionof{figure}{ex12term\_aip Verteilungen}
			\end{minipage}
