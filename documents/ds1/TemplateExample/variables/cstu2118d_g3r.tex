%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{cstu2118d\_g3r}
	\label{subSection:cstu2118d_g3r}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:cstu2118d_g3r}
			Name & cstu2118d\_g3r \\
			Label & 18. Tätigkeit: Staat einer ausl. Hochschule \\
			Beschreibung & - \\
 ...
 \\
		...
		\end{tabular}
			...
			\noindent\textbf{Werte:}\\
			\begin{table}[!ht]
				\label{tableValues:cstu2118d_g3r}
				\centering
				\begin{tabular}{C{1cm}L{6cm}rrR{1.5cm}}
					...
					\bottomrule		
				\end{tabular}
				\caption{Werte der Variable cstu2118d\_g3r}
			\end{table}
