%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{cstu2113a\_g1r}
	\label{subSection:cstu2113a_g1r}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:cstu2113a_g1r}
			Name & cstu2113a\_g1r \\
			Label & 13. Tätigkeit: 1. Studienfach (Studienbereich) \\
			Beschreibung & - \\
 ...
 \\
		...
		\end{tabular}
			...
			\noindent\textbf{Werte:}\\
			\begin{table}[!ht]
				\label{tableValues:cstu2113a_g1r}
				\centering
				\begin{tabular}{C{1cm}L{6cm}rrR{1.5cm}}
					...
					\multicolumn{5}{l}{\textbf{Gültige Werte}}\\										
								...
								10 & Anglisitik & 1 & 0 & 11.11 \\
								15 & Psychologie & 1 & 0 & 11.11 \\
								42 & Biologie & 1 & 0 & 11.11 \\
								49 & Humanmedizin (ohne Zahnmedizin) & 5 & 0.02 & 55.56 \\
					...
					\bottomrule		
				\end{tabular}
				\caption{Werte der Variable cstu2113a\_g1r}
			\end{table}
