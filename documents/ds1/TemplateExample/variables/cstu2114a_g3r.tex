%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{cstu2114a\_g3r}
	\label{subSection:cstu2114a_g3r}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:cstu2114a_g3r}
			Name & cstu2114a\_g3r \\
			Label & 14. Tätigkeit: 1. Studienfach (Fächergruppe) \\
			Beschreibung & - \\
 ...
 \\
		...
		\end{tabular}
			...
			\noindent\textbf{Werte:}\\
			\begin{table}[!ht]
				\label{tableValues:cstu2114a_g3r}
				\centering
				\begin{tabular}{C{1cm}L{6cm}rrR{1.5cm}}
					...
					\multicolumn{5}{l}{\textbf{Gültige Werte}}\\										
								...
								1 & Sprach-/Kultur-/Sportwissenschaften & 1 & 0 & 33.33 \\
								3 & Mathematik/Naturwissenschaften & 1 & 0 & 33.33 \\
								4 & Human-/Zahn-/Tiermedizin & 1 & 0 & 33.33 \\
					...
					\bottomrule		
				\end{tabular}
				\caption{Werte der Variable cstu2114a\_g3r}
			\end{table}
