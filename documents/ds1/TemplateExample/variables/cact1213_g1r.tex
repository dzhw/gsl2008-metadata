%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{cact1213\_g1r}
	\label{subSection:cact1213_g1r}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:cact1213_g1r}
			Name & cact1213\_g1r \\
			Label & 13. Tätigkeit: Tätigkeitsart \\
			Beschreibung & - \\
 ...
 \\
		...
		\end{tabular}
			...
			\noindent\textbf{Werte:}\\
			\begin{table}[!ht]
				\label{tableValues:cact1213_g1r}
				\centering
				\begin{tabular}{C{1cm}L{6cm}rrR{1.5cm}}
					...
					\multicolumn{5}{l}{\textbf{Gültige Werte}}\\										
								...
								1 & Fachhochschule & 1 & 0 & 11.11 \\
								2 & Universität & 4 & 0.01 & 44.44 \\
								10 & Ausländische Hochschule & 2 & 0.01 & 22.22 \\
								49 & Uni / Praktikum & 2 & 0.01 & 22.22 \\
					...
					\bottomrule		
				\end{tabular}
				\caption{Werte der Variable cact1213\_g1r}
			\end{table}
