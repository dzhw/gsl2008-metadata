%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{reifterm\_aip}
	\label{subSection:reifterm_aip}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:reifterm_aip}
			Name & reifterm\_aip \\
			Label & Termin der Hochschulreife \\
			Beschreibung & - \\
		...
		\end{minipage}%				
			...
			\begin{axis}
	    		[
		    	    ...
		    	    use comma,
	    	    		1000 sep={},
    				ytick = {200800,200810,200810,200810,200810},
	  		...
	  		\end{axis}
			\end{tikzpicture}
			\captionof{figure}{reifterm\_aip Verteilungen}
			\end{minipage}
