%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{cbeg29\_g2r}
	\label{subSection:cbeg29_g2r}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:cbeg29_g2r}
			Name & cbeg29\_g2r \\
			Label & 9. Job: Beginn (Monat) \\
			Beschreibung & - \\
 ...
 \\
		...
		\end{minipage}%				
			...
			\label{tableValues:cbeg29_g2r}
				...
				\bottomrule					
				\end{tabular}
				\caption{Werte der Variable cbeg29\_g2r}
			\end{table}
