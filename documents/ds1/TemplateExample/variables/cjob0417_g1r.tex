%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{cjob0417\_g1r}
	\label{subSection:cjob0417_g1r}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:cjob0417_g1r}
			Name & cjob0417\_g1r \\
			Label & 17. Tätigkeit: Beruf Erwerbstätigkeit \\
			Beschreibung & - \\
 ...
 \\
		...
		\end{tabular}
			...
			\noindent\textbf{Werte:}\\
			\begin{table}[!ht]
				\label{tableValues:cjob0417_g1r}
				\centering
				\begin{tabular}{C{1cm}L{6cm}rrR{1.5cm}}
					...
					\bottomrule		
				\end{tabular}
				\caption{Werte der Variable cjob0417\_g1r}
			\end{table}
