%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{ende07\_aip}
	\label{subSection:ende07_aip}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:ende07_aip}
			Name & ende07\_aip \\
			Label & Endtermin 7.Tätigkeit \\
			Beschreibung & - \\
 ...
 \\
		...
		\end{minipage}%				
			...
			\begin{axis}
	  		...
	  		\end{axis}
			\end{tikzpicture}
			\captionof{figure}{ende07\_aip Verteilungen}
			\end{minipage}
