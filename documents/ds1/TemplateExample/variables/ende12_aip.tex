%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{ende12\_aip}
	\label{subSection:ende12_aip}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:ende12_aip}
			Name & ende12\_aip \\
			Label & Endtermin 12.Tätigkeit \\
			Beschreibung & - \\
 ...
 \\
		...
		\end{minipage}%				
			...
			\begin{axis}
	  		...
	  		\end{axis}
			\end{tikzpicture}
			\captionof{figure}{ende12\_aip Verteilungen}
			\end{minipage}
