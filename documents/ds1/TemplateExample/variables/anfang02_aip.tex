%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{anfang02\_aip}
	\label{subSection:anfang02_aip}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:anfang02_aip}
			Name & anfang02\_aip \\
			Label & Anfangstermin 2.Tätigkeit \\
			Beschreibung & - \\
 ...
 \\
		...
		\end{minipage}%				
			...
			\begin{axis}
	  		...
	  		\end{axis}
			\end{tikzpicture}
			\captionof{figure}{anfang02\_aip Verteilungen}
			\end{minipage}
