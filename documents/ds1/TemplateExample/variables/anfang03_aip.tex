%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{anfang03\_aip}
	\label{subSection:anfang03_aip}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:anfang03_aip}
			Name & anfang03\_aip \\
			Label & Anfangstermin 3.Tätigkeit \\
			Beschreibung & - \\
		...
		\end{minipage}%				
			...
			\begin{axis}
	    		[
		    	    ...
		    	    use comma,
	    	    		1000 sep={},
    				ytick = {200810,200900,200910,201110,201210},
	  		...
	  		\end{axis}
			\end{tikzpicture}
			\captionof{figure}{anfang03\_aip Verteilungen}
			\end{minipage}
