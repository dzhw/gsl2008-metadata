%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{anfang04\_aip}
	\label{subSection:anfang04_aip}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:anfang04_aip}
			Name & anfang04\_aip \\
			Label & Anfangstermin 4.Tätigkeit \\
			Beschreibung & - \\
		...
		\end{minipage}%				
			...
			\begin{axis}
	    		[
		    	    ...
		    	    use comma,
	    	    		1000 sep={},
    				ytick = {200810,200910,201100,201200,201210},
	  		...
	  		\end{axis}
			\end{tikzpicture}
			\captionof{figure}{anfang04\_aip Verteilungen}
			\end{minipage}
