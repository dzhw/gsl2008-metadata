%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{ende06\_aip}
	\label{subSection:ende06_aip}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:ende06_aip}
			Name & ende06\_aip \\
			Label & Endtermin 6.Tätigkeit \\
			Beschreibung & - \\
 ...
 \\
		...
		\end{minipage}%				
			...
			\begin{axis}
	  		...
	  		\end{axis}
			\end{tikzpicture}
			\captionof{figure}{ende06\_aip Verteilungen}
			\end{minipage}
