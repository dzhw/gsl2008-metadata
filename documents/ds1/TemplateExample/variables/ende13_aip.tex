%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{ende13\_aip}
	\label{subSection:ende13_aip}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:ende13_aip}
			Name & ende13\_aip \\
			Label & Endtermin 13.Tätigkeit \\
			Beschreibung & - \\
 ...
 \\
		...
		\end{minipage}%				
			...
			\begin{axis}
	  		...
	  		\end{axis}
			\end{tikzpicture}
			\captionof{figure}{ende13\_aip Verteilungen}
			\end{minipage}
