%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{cvoc0819\_g2r}
	\label{subSection:cvoc0819_g2r}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:cvoc0819_g2r}
			Name & cvoc0819\_g2r \\
			Label & 19. Tätigkeit: Berufsbereich Ausbildung \\
			Beschreibung & - \\
 ...
 \\
		...
		\end{tabular}
			...
			\noindent\textbf{Werte:}\\
			\begin{table}[!ht]
				\label{tableValues:cvoc0819_g2r}
				\centering
				\begin{tabular}{C{1cm}L{6cm}rrR{1.5cm}}
					...
					\bottomrule		
				\end{tabular}
				\caption{Werte der Variable cvoc0819\_g2r}
			\end{table}
