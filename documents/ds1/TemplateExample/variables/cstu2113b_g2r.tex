%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{cstu2113b\_g2r}
	\label{subSection:cstu2113b_g2r}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:cstu2113b_g2r}
			Name & cstu2113b\_g2r \\
			Label & 13. Tätigkeit: 2. Studienfach (Studiengattung) \\
			Beschreibung & - \\
 ...
 \\
		...
		\end{tabular}
			...
			\noindent\textbf{Werte:}\\
			\begin{table}[!ht]
				\label{tableValues:cstu2113b_g2r}
				\centering
				\begin{tabular}{C{1cm}L{6cm}rrR{1.5cm}}
					...
					\multicolumn{5}{l}{\textbf{Gültige Werte}}\\										
								...
								1 & Sprach- und Kulturwissenschaften & 1 & 0 & 100 \\
					...
					\bottomrule		
				\end{tabular}
				\caption{Werte der Variable cstu2113b\_g2r}
			\end{table}
