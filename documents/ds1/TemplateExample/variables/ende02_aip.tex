%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{ende02\_aip}
	\label{subSection:ende02_aip}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:ende02_aip}
			Name & ende02\_aip \\
			Label & Endtermin 2.Tätigkeit \\
			Beschreibung & - \\
 ...
 \\
		...
		\end{minipage}%				
			...
			\begin{axis}
	  		...
	  		\end{axis}
			\end{tikzpicture}
			\captionof{figure}{ende02\_aip Verteilungen}
			\end{minipage}
