%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{anfang07\_aip}
	\label{subSection:anfang07_aip}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:anfang07_aip}
			Name & anfang07\_aip \\
			Label & Anfangstermin 7.Tätigkeit \\
			Beschreibung & - \\
		...
		\end{minipage}%				
			...
			\begin{axis}
	    		[
		    	    ...
		    	    use comma,
	    	    		1000 sep={},
    				ytick = {200950,201110,201200,201210,201210},
	  		...
	  		\end{axis}
			\end{tikzpicture}
			\captionof{figure}{anfang07\_aip Verteilungen}
			\end{minipage}
