%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{anfang09\_aip}
	\label{subSection:anfang09_aip}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:anfang09_aip}
			Name & anfang09\_aip \\
			Label & Anfangstermin 9.Tätigkeit \\
			Beschreibung & - \\
		...
		\end{minipage}%				
			...
			\begin{axis}
	    		[
		    	    ...
		    	    use comma,
	    	    		1000 sep={},
    				ytick = {201000,201110,201200,201210,201210},
    			...
    			\addplot+[
      			...
      			lower quartile=201110,
	    		  	...
	    		  	lower whisker=201000
    				},
    			] coordinates {};
	  		\end{axis}
			\end{tikzpicture}
			\captionof{figure}{anfang09\_aip Verteilungen}
			\end{minipage}
