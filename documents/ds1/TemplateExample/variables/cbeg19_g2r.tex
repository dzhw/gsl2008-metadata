%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{cbeg19\_g2r}
	\label{subSection:cbeg19_g2r}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:cbeg19_g2r}
			Name & cbeg19\_g2r \\
			Label & 19. Tätigkeit: Beginn (Monat)  \\
			Beschreibung & - \\
 ...
 \\
		...
		\end{minipage}%				
			...
			\label{tableValues:cbeg19_g2r}
				...
				\bottomrule					
				\end{tabular}
				\caption{Werte der Variable cbeg19\_g2r}
			\end{table}
