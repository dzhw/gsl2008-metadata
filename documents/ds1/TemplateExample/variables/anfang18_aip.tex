%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{anfang18\_aip}
	\label{subSection:anfang18_aip}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:anfang18_aip}
			Name & anfang18\_aip \\
			Label & Anfangstermin 18.Tätigkeit \\
			Beschreibung & - \\
		...
		\end{minipage}%				
			...
			\begin{axis}
	    		[
		    	    ...
		    	    use comma,
	    	    		1000 sep={},
    				ytick = {201210,201210,201210,201210,201210},
    			...
    			\addplot+[
      			...
      			lower quartile=201210,
	    		  	...
	    		  	lower whisker=201210
    				},
    			] coordinates {};
	  		\end{axis}
			\end{tikzpicture}
			\captionof{figure}{anfang18\_aip Verteilungen}
			\end{minipage}
