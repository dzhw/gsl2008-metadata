%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{anfang14\_aip}
	\label{subSection:anfang14_aip}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:anfang14_aip}
			Name & anfang14\_aip \\
			Label & Anfangstermin 14.Tätigkeit \\
			Beschreibung & - \\
		...
		\end{minipage}%				
			...
			\begin{axis}
	    		[
		    	    ...
		    	    use comma,
	    	    		1000 sep={},
    				ytick = {201110,201110,201200,201210,201210},
    			...
    			\addplot+[
      			...
      			lower quartile=201110,
	    		  	...
	    		  	lower whisker=201110
    				},
    			] coordinates {};
	  		\end{axis}
			\end{tikzpicture}
			\captionof{figure}{anfang14\_aip Verteilungen}
			\end{minipage}
