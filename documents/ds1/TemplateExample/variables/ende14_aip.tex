%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{ende14\_aip}
	\label{subSection:ende14_aip}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:ende14_aip}
			Name & ende14\_aip \\
			Label & Endtermin 14.Tätigkeit \\
			Beschreibung & - \\
		...
		\end{minipage}%				
			...
			\begin{axis}
	    		[
		    	    ...
		    	    use comma,
	    	    		1000 sep={},
    				ytick = {201110,201110,201210,201210,201210},
	  		...
	  		\end{axis}
			\end{tikzpicture}
			\captionof{figure}{ende14\_aip Verteilungen}
			\end{minipage}
