%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{cend10\_g1r}
	\label{subSection:cend10_g1r}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:cend10_g1r}
			Name & cend10\_g1r \\
			Label & 10. Tätigkeit: Ende (Jahr)  \\
			Beschreibung & - \\
 ...
 \\
		...
		\noindent\textbf{Statistische Daten:}\\
			\begin{tabular}{ll}
				\label{tableStatistics:cend10_g1r}
		...
		\end{minipage}%				
			...
			\begin{axis}
	  		...
	  		\end{axis}
			\end{tikzpicture}
			\captionof{figure}{cend10\_g1r Verteilungen}
			\end{minipage}
			...
			\label{tableValues:cend10_g1r}
				...
				\bottomrule					
				\end{tabular}
				\caption{Werte der Variable cend10\_g1r}
			\end{table}
