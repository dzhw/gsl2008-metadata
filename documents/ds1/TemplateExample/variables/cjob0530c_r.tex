%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{cjob0530c\_r}
	\label{subSection:cjob0530c_r}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:cjob0530c_r}
			Name & cjob0530c\_r \\
			Label & 10. Job: Stunden pro Monat \\
			Beschreibung & - \\
 ...
 \\
		...
		\end{minipage}%				
			...
			\label{tableValues:cjob0530c_r}
				...
				\bottomrule					
				\end{tabular}
				\caption{Werte der Variable cjob0530c\_r}
			\end{table}
