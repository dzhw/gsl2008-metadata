%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{ende18\_aip}
	\label{subSection:ende18_aip}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:ende18_aip}
			Name & ende18\_aip \\
			Label & Endtermin 18.Tätigkeit \\
			Beschreibung & - \\
 ...
 \\
		...
		\end{minipage}%				
			...
			\begin{axis}
	  		...
	  		\end{axis}
			\end{tikzpicture}
			\captionof{figure}{ende18\_aip Verteilungen}
			\end{minipage}
