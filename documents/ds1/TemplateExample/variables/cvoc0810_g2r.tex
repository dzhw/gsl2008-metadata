%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{cvoc0810\_g2r}
	\label{subSection:cvoc0810_g2r}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:cvoc0810_g2r}
			Name & cvoc0810\_g2r \\
			Label & 10. Tätigkeit: Berufsbereich Ausbildung \\
			Beschreibung & - \\
 ...
 \\
		...
		\end{tabular}
			...
			\noindent\textbf{Werte:}\\
			\begin{table}[!ht]
				\label{tableValues:cvoc0810_g2r}
				\centering
				\begin{tabular}{C{1cm}L{6cm}rrR{1.5cm}}
					...
					\multicolumn{5}{l}{\textbf{Gültige Werte}}\\										
								...
								780 & Bürofachkräfte, Kaufmännische Angestellte o.n.A. & 1 & 0 & 100 \\
					...
					\bottomrule		
				\end{tabular}
				\caption{Werte der Variable cvoc0810\_g2r}
			\end{table}
