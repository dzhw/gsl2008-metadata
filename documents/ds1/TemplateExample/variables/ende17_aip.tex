%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{ende17\_aip}
	\label{subSection:ende17_aip}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:ende17_aip}
			Name & ende17\_aip \\
			Label & Endtermin 17.Tätigkeit \\
			Beschreibung & - \\
 ...
 \\
		...
		\end{minipage}%				
			...
			\begin{axis}
	  		...
	  		\end{axis}
			\end{tikzpicture}
			\captionof{figure}{ende17\_aip Verteilungen}
			\end{minipage}
