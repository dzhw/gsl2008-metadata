%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{ende05\_aip}
	\label{subSection:ende05_aip}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:ende05_aip}
			Name & ende05\_aip \\
			Label & Endtermin 5.Tätigkeit \\
			Beschreibung & - \\
 ...
 \\
		...
		\end{minipage}%				
			...
			\begin{axis}
	  		...
	  		\end{axis}
			\end{tikzpicture}
			\captionof{figure}{ende05\_aip Verteilungen}
			\end{minipage}
