%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{cjob0529d\_r}
	\label{subSection:cjob0529d_r}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:cjob0529d_r}
			Name & cjob0529d\_r \\
			Label & 9. Job: Netto-Monatseinkommen \\
			Beschreibung & - \\
 ...
 \\
		...
		\end{minipage}%				
			...
			\label{tableValues:cjob0529d_r}
				...
				\bottomrule					
				\end{tabular}
				\caption{Werte der Variable cjob0529d\_r}
			\end{table}
