%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{cvoc0810\_g1r}
	\label{subSection:cvoc0810_g1r}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:cvoc0810_g1r}
			Name & cvoc0810\_g1r \\
			Label & 10. Tätigkeit: Ausbildungsberuf \\
			Beschreibung & - \\
 ...
 \\
		...
		\end{tabular}
			...
			\noindent\textbf{Werte:}\\
			\begin{table}[!ht]
				\label{tableValues:cvoc0810_g1r}
				\centering
				\begin{tabular}{C{1cm}L{6cm}rrR{1.5cm}}
					...
					\multicolumn{5}{l}{\textbf{Gültige Werte}}\\										
								...
								7803 & Bürokaufleute, Kontorist(en/innen) o.n.A. & 1 & 0 & 100 \\
					...
					\bottomrule		
				\end{tabular}
				\caption{Werte der Variable cvoc0810\_g1r}
			\end{table}
