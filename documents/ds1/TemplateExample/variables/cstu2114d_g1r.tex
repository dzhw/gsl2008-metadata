%EVERY VARIABLE HAS A OWN PAGE
	...
	\subsection{cstu2114d\_g1r}
	\label{subSection:cstu2114d_g1r}

	%TABLE FOR THE VARIABLE DETAILS
	\noindent\textbf{Variable:}\\
		\begin{tabular}{lL{11.3cm}}
			\label{tableVariable:cstu2114d_g1r}
			Name & cstu2114d\_g1r \\
			Label & 14. Tätigkeit: Bundesland der HS \\
			Beschreibung & - \\
 ...
 \\
		...
		\end{tabular}
			...
			\noindent\textbf{Werte:}\\
			\begin{table}[!ht]
				\label{tableValues:cstu2114d_g1r}
				\centering
				\begin{tabular}{C{1cm}L{6cm}rrR{1.5cm}}
					...
					\multicolumn{5}{l}{\textbf{Gültige Werte}}\\										
								...
								5 & Nordrhein-Westfalen & 1 & 0 & 33.33 \\
								6 & Hessen & 1 & 0 & 33.33 \\
								9 & Bayern & 1 & 0 & 33.33 \\
					...
					\bottomrule		
				\end{tabular}
				\caption{Werte der Variable cstu2114d\_g1r}
			\end{table}
